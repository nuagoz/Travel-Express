...
module.exports = "<ngx-loading-bar [color]=\"'#ff0000'\"></ngx-loading-bar>\n<app-navbar></app-navbar>\n<router-outlet></router-outlet>\n\n"
...
/* harmony import */ var _ngx_loading_bar_http__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @ngx-loading-bar/http */ "./node_modules/@ngx-loading-bar/http/esm5/ngx-loading-bar-http.js");
...
module.exports = "<div id=\"registercontainer\" class=\"container\">\n    <div class=\"row justify-content-center\">\n      <div class=\"col-md-6\">\n        <div class=\"card\">\n          <header class=\"text-center card-header\">\n            <!--<a routerLink=\"/login\" class=\"float-right btn btn-outline-primary mt-1\">Connexion</a>-->\n            <h4 class=\"card-title mt-2\">Se connecter</h4>\n          </header>\n          <article class=\"card-body\">\n            <form (submit)=\"login()\">\n              <!-- form-row end.// -->\n              <div class=\"form-group\">\n                <div class=\"md-form nomargin\">\n                  <input mdbInputDirective [mdbValidate]=\"false\" data-error=\"Mauvais format d'email\" type=\"email\" id=\"form_mail\" class=\"form-control\" name=\"mail\" [(ngModel)]=\"credentials.mail\">\n                  <label for=\"form_mail\">E-mail</label>\n                </div>\n              </div>\n              <div class=\"form-group\">\n                <div class=\"md-form\">\n                  <input mdbInputDirective [mdbValidate]=\"false\" type=\"password\" id=\"form_mdp\" class=\"form-control\" name=\"password\" [(ngModel)]=\"credentials.password\">\n                  <label for=\"form_mdp\" class=\"\">Mot de passe</label>\n                </div>\n              </div>\n              <!-- form-group end.// -->\n              <div class=\"form-group\">\n                <button mdbBtn type=\"submit\" color=\"info\" class=\"waves-light btn btn-block\" mdbWavesEffect>Connexion</button>\n              </div>\n              <!-- form-group// -->      \n            </form>\n          </article>\n          <!-- card-body end .// -->\n        </div>\n        <!-- card.// -->\n      </div>\n      <!-- col.//-->\n    </div>\n    <!-- row.//-->\n  </div>"
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.auth.login(this.credentials).subscribe(function () {
            ...
            _this.toastr.success("Connecté", "", { timeOut: 1000 });
        }, function (err) {
            console.error(err);
        });
    };
    ...
    LoginComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_authentication_service__WEBPACK_IMPORTED_MODULE_1__["AuthenticationService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], ngx_toastr__WEBPACK_IMPORTED_MODULE_3__["ToastrService"]])
    ], LoginComponent);
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(auth, toastr) {
        this.auth = auth;
        this.toastr = toastr;
    }
...
module.exports = "<div id=\"registercontainer\" class=\"container\">\n    <div class=\"row justify-content-center\">\n      <div class=\"col-md-6\">\n        <div class=\"card\">\n          <header class=\"text-center card-header\">\n            <!--<a routerLink=\"/login\" class=\"float-right btn btn-outline-primary mt-1\">Connexion</a>-->\n            <h4 class=\"card-title mt-2\">Inscription</h4>\n          </header>\n          <article class=\"card-body\">\n            <div *ngIf=\"formError\" id=\"registermsg\" class=\"alert alert-danger\" role=\"alert\">\n              <b>Erreur : </b> {{ msgError }}\n            </div>\n            <form (submit)=\"register()\">\n              <div class=\"form-row\">\n                <div class=\"col\">\n                  <div class=\"md-form\">\n                    <input mdbInputDirective [mdbValidate]=\"false\" type=\"text\" id=\"form_prenom\" class=\"form-control\" name=\"prenom\" [(ngModel)]=\"credentials.prenom\">\n                    <label for=\"form_prenom\">Prénom</label>\n                  </div>\n                </div>\n                <!-- form-group end.// -->\n                <div class=\"col\">\n                  <div class=\"md-form\">\n                    <input mdbInputDirective [mdbValidate]=\"false\" type=\"text\" id=\"form_nom\" class=\"form-control\" name=\"nom\" [(ngModel)]=\"credentials.nom\">\n                    <label for=\"form_nom\" class=\"\">Nom</label>\n                  </div>\n                </div>\n                <!-- form-group end.// -->\n              </div>\n              <!-- form-row end.// -->\n              <div class=\"form-group\">\n                <div class=\"md-form nomargin\">\n                  <input mdbInputDirective [mdbValidate]=\"false\" data-error=\"Mauvais format d'email\" type=\"email\" id=\"form_mail\" class=\"form-control\" name=\"mail\" [(ngModel)]=\"credentials.mail\">\n                  <label for=\"form_mail\">E-mail</label>\n                </div>\n              </div>\n              <div class=\"form-group\">\n                <div class=\"md-form nomargin\">\n                  <input mdbInputDirective [mdbValidate]=\"false\" type=\"text\" id=\"form_tel\" class=\"form-control\" name=\"tel\" [(ngModel)]=\"credentials.tel\">\n                  <label for=\"form_tel\" class=\"\">Téléphone</label>\n                </div>\n              </div>\n              <div class=\"form-group\">\n                <div class=\"md-form\">\n                  <input mdbInputDirective [mdbValidate]=\"false\" type=\"password\" id=\"form_mdp1\" class=\"form-control\" name=\"password1\" [(ngModel)]=\"credentials.password1\">\n                  <label for=\"form_mdp1\" class=\"\">Mot de passe</label>\n                </div>\n              </div>\n              <!-- form-group end.// -->\n              <div class=\"form-group\">\n                <div class=\"md-form\">\n                  <input mdbInputDirective [mdbValidate]=\"false\" type=\"password\" id=\"form_mdp2\" class=\"form-control\" name=\"password2\" [(ngModel)]=\"credentials.password2\">\n                  <label for=\"form_mdp2\" class=\"\">Retapez le mot de passe</label>\n                </div>\n              </div>\n              <!-- form-group end.// -->\n              <div class=\"form-group\">\n                <button mdbBtn type=\"submit\" color=\"info\" class=\"waves-light btn btn-block\" mdbWavesEffect>Valider</button>\n              </div>\n              <!-- form-group// -->      \n            </form>\n          </article>\n          <!-- card-body end .// -->\n          <div class=\"border-top card-body text-center\">Have an account? <a href=\"\">Log In</a></div>\n        </div>\n        <!-- card.// -->\n      </div>\n      <!-- col.//-->\n    </div>\n    <!-- row.//-->\n  </div>"
...
var AuthenticationService = /** @class */ (function () {
    ...
    AuthenticationService.prototype.request = function (method, type, user) {
        ...
        var base;
        if (method == 'post')
            base = this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api + "/" + type, user);
        else
            base = this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api + "/" + type, { headers: { Authorization: "Bearer " + this.getToken() } });
...
module.exports = __webpack_require__(/*! D:\Prog\Travel Express\angular-src\src\main.ts */"./src/main.ts");
